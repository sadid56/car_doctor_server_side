...
async function run() {
  try {
    ...
    const carDoctorCollection = client.db('carDocdor').collection('services')
    const bookingCollection = client.db('carDocdor').collection('booking')
    ...
    app.get('/services',logger,  async(req, res)=>{
        const cursur = carDoctorCollection.find()
